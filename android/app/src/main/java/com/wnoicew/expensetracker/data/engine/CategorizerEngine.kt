...
object CategorizerEngine {
    ...
    fun cleanIndianTransactionTitle(rawNarration: String, transactionType: TransactionType = TransactionType.EXPENSE): String {
        ...
        val brandMap = mapOf(
            ...
            "contact11" to "Contact 11",
            "contact7" to "Contact 7",
            "contact8" to "Contact 8",
            "indstock" to "INDstocks (Trading)",
            "mutual f" to "Groww Mutual Funds (BSE)",
            "iccl" to "ICCL (Groww Mutual Funds)",
            "contact9" to "Contact 9",
            "contact5" to "Contact 5",
            "contact1" to "Contact 1",
            "contact3" to "Contact 3",
            "contact2" to "Contact 2",
            "contact4" to "Contact 4",
            "contact10" to "Contact 10",
            "contact6" to "Contact 6",
