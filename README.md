...
[![Version](https://img.shields.io/badge/version-1.1.4-10b981.svg?style=flat-square)](https://github.com/wNoicEw/expense-tracker/releases/tag/v1.1.4)
[![Android](https://img.shields.io/badge/android-v1.1.4%20(SDK%2035)-3DDC84.svg?style=flat-square&logo=android&logoColor=white)](#-native-android-application-v114)
...
## 📱 Native Android Application (v1.1.4)
...
- **Direct APK Distribution**:
  ...
  - **Version Archive**: [**`apks/`**](apks/) (`ExpenseTracker-v1.0.0.apk`, `ExpenseTracker-v1.1.0.apk`, `ExpenseTracker-v1.1.1.apk`, `ExpenseTracker-v1.1.2.apk`, `ExpenseTracker-v1.1.3.apk`, `ExpenseTracker-v1.1.4.apk`)
...
- **Current Release:** [`v1.1.4`](https://github.com/wNoicEw/expense-tracker/releases/tag/v1.1.4) — *Account balance sign fix, safer duplicate auto-merge, specific-keyword categorization, CDN script integrity (SRI), Android backup/release hygiene, and a data-backup reminder banner.*
